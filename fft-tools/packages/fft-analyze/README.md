...
- **Orientation:** Note that the angles are in the frequency domain. A peak at 90° (North-South in frequency) corresponds to East-West striking features in the spatial domain.
