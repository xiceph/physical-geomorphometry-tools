...
Partial measure of gravity discordant curvature expressing difference between basic tangential curvature (_k<sub>n</sub>_)_<sub>c</sub>_ and minimal curvature _k<sub>min</sub>_.
